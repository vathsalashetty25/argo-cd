...
./dist/openapi-gen \
  ...
  --input-dirs github.com/vathsalashetty96/argo-cd/v2/pkg/apis/application/${VERSION} \
  --output-package github.com/vathsalashetty96/argo-cd/v2/pkg/apis/application/${VERSION} \
